<?php
    ...
    try {
        ...
        $mail->Body .= '<p>Bạn đã được thêm làm quản trị viên thành công, để xác thực tài khoản, bạn vui lòng nhấp vào đường link dưới đây:</p>'; 
        $mail->Body .= '<a href="http://localhost:8080/DMS/Admin/activation.php?accout=' . $email . '&code=' . $strActivation . '">Click here</a>';
