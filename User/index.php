    ...
    <body>
        <div id="wrap-fluid">
            ...
            <div id="menu">
                ...
                <li style="margin-left:50em;padding-top:5px;"><i class="fas fa-user-circle"></i><?php echo $username?></li>
                <li><a href="../logout.php"><i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
                <div id="side">
            
                <table style=" font-size: 20px;margin-top: 70px;border: 2px red;background-color: green;">
                <tr>
